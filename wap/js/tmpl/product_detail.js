      ...
      $.ajax({
         ...
         success:function(result){
            ...
            if(!data.error){
              ...
              z_goods_type = data.goods_info.z_goods_type;
              if(z_goods_type == "1" && location.pathname.indexOf("product_sale_detail.html") == -1) {
                location.replace(location.href.replace(location.pathname, '/wap/tmpl/product_sale_detail.html'));
              } else if(z_goods_type == "2" && location.pathname.indexOf("product_asale_detail.html") == -1) {
                location.replace(location.href.replace(location.pathname, '/wap/tmpl/product_asale_detail.html'));
              } else if(z_goods_type == "3" && location.pathname.indexOf("product_discount_detail.html") == -1) {
                location.replace(location.href.replace(location.pathname, '/wap/tmpl/product_discount_detail.html'));
              }
              //商品规格格式化数据
