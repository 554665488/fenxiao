$(function(){
	...
	if(key){
        $.ajax({
            ...
            success:function(result){
                ...
                var html = '<li><a href="order_list.html?data-state=state_new">'+ (result.datas.member_info.order_nopay_count > 0 ? '<em></em>' : '') +'<i class="cc-01"></i><p>待付款</p></a></li>'
                    ...
                    + '<li><a href="order_list.html?data-state=state_notakes">' + (result.datas.member_info.order_notakes_count > 0 ? '<em></em>' : '') + '<i class="cc-03"></i><p>待预售</p></a></li>'
                    + '<li><a href="order_list.html?data-state=state_noeval">' + (result.datas.member_info.order_noeval_count > 0 ? '<em></em>' : '') + '<i class="cc-04"></i><p>预售中</p></a></li>'
                ...
                var html = '<li><a href="predepositlog_list.html"><i class="cc-06"></i><p>预存款</p></a></li>'
                    + '<li><a href="rechargecardlog_list.html"><i class="cc-07"></i><p>优惠券</p></a></li>'
        ...
        + '<li><a href="login.html"><i class="cc-03"></i><p>待预售</p></a></li>'
        + '<li><a href="login.html"><i class="cc-04"></i><p>预售中</p></a></li>'
