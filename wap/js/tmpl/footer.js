$(function (){
    ...
    if(key){
        ...
        html += '<a href="' + WapSiteUrl + '/cms">资讯</a>' + "</div>" + '<!--<div class="copyright">' + 'Copyright&nbsp;&copy;&nbsp;2005-2018 <a href="javascript:void(0);"></a>版权所有' + "</div>--></div>";
      ...
      if (cart_count > 0) {
		...
		+'<li><a href="'+WapSiteUrl+'/tmpl/member/member.html"><i class="member"></i><p>我</p></a></li></ul>'
		+'</div>';
      	} else {
      	var fnav = '<div id="footnav" class="footnav clearfix"><ul>'
		+'<li><a href="'+WapSiteUrl+'"><i class="home"></i><p>首页</p></a></li>'
