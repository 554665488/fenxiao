$(function () {
                ...
                success: function (result) {
                    ...
                    if (!result.datas.error) {
                        if (typeof(result.datas.key) == 'undefined') {
                            ...
                            addCookie('member_mobile', result.datas.member_mobile, expireHours);
    ...
    $('.qq').click(function () {
        location.href = ApiUrl + '/index.php?act=WXLogin&op=wx_login';
        //location.href = ApiUrl+'/index.php?act=connect&op=indexapi';
    })
