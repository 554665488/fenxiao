...
class memberModel extends Model {
	...
	*/
	...
	// 会员添加
        ...
        $member_info['member_paypwd']        = $register_info['paypassword'];
    ...
    $member_info['inviter_ids']      = $register_info['inviter_ids'];
    ...
    public function addMember($param) {
        ...
        $member_info['inviter_ids']	        = $param['inviter_ids'];
			//33hao 5.2 分销
			...
			//Model('points')->savePointsLog('regist',array('pl_memberid'=>$insert_id,'pl_membername'=>$param['member_name']),false);
				...
				//Model('points2')->savePointsLog('inviter',array('pl_memberid'=>$member_info['inviter_id'],'pl_membername'=>$inviter_name,'invited'=>$member_info['member_name']));
            }
