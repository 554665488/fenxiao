...
class connect_apiLogic {
     ...
     * @return string
     */
    public function getWxOAuth2Url($recmember){
        $weixin_appid = C('wap_weixin_appid');
        
        $api_url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid='.$weixin_appid.
            '&redirect_uri='.urlencode(MOBILE_SITE_URL.'/index.php?act=connect&op=index&recmember='.$recmember).
...
/**
     ...
     * @return array
     */
    public function getWxUserInfo2($code, $api_type = ''){
        $weixin_appid = C('weixin_appid');
        $weixin_secret = C('weixin_secret');
        if($api_type == 'api'){
            $weixin_appid = C('app_weixin_appid');
     ...
     * @return string
     */
    public function getUrlContents2($url){
