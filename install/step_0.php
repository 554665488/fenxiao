...
<div class="main">
  <div class="text-box" id="text-box">
    <div class="license">
      <h1>好商城v5.7 安装协议</h1>
      <p>感谢你选择好商城系统，本系统由好商城根据网域天创网络流传的版本所改进版本，系统版权归属于软件开发商，只用于学习研究交流使用。</p>
      <p>
用户须知：本协议是您与好商城之间关于您安装使用好商城吾爱破解提供的好商城B2B2C多商户版电商系统及服务的法律协议。无论您是个人组织、盈利与否、用途如何（包括以学习和研究为目的），均与好商城无关！好商城只提供相关技术服务！不负责任何商业责任！还请知悉。</p>
      <p></p>
...
<div class="footer">
 <h6><a href="https://www.bbs.sasadown.cn/" target="_blank">程序来源于 莎莎源码 bbs.sasadown.cn</a></h6>
</div>
