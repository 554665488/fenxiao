...
(15, 9, '首页通栏app', 'a:2:{s:7:"adv_pic";s:21:"05730526734558396.png";s:11:"adv_pic_url";s:13:"app.33hao.com";}', 1388505600, 1577721600, 0, 0, '', 0, 1, '', 0),
(935, 11, '好商城活动', 'a:2:{s:7:"adv_pic";s:21:"05730518012362169.png";s:11:"adv_pic_url";s:20:"http://www.33hao.com";}', 1434211200, 1749312000, 0, 0, '', 0, 1, '', 0),
(936, 1047, '好商城V5.7', 'a:2:{s:7:"adv_pic";s:21:"04891676111561966.png";s:11:"adv_pic_url";s:13:"www.33hao.com";}', 1435766400, 1753891200, 0, 0, '', 0, 1, '', 0),
(937, 37, '好商城app', 'a:2:{s:7:"adv_pic";s:21:"05730529864621343.png";s:11:"adv_pic_url";s:13:"app.33hao.com";}', 1519660800, 1676390400, 0, 0, '', 0, 1, '', 0);
...
(37, '商品列表页底部广告位', 0, 1, 1, 1200, 90, 1, 0, '05730529324054085.png'),
...
('<strong>[用户]</strong>身份验证通知', '账户安全认证 - {$site_name}', 'authenticate', '【{$site_name}】提交账户安全验证，验证码是：{$verify_code}。'),
...
('<strong>[用户]</strong>手机验证通知', '手机验证通知 - {$site_name}', 'modify_mobile', '【{$site_name}】绑定手机号，验证码是：{$verify_code}。'),
...
CREATE TABLE `#__member` (
  ...
  `available_predeposit` decimal(10,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '现金券可用金额',
  `freeze_predeposit` decimal(10,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '现金券冻结金额',
...
(22, 0, '二手市场', 'index.php?act=flea', 1, 0, 5, 0);
...
CREATE TABLE `#__orders` (
  ...
  `pd_amount` decimal(10,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '现金券支付金额',
...
CREATE TABLE `#__order_book` (
  ...
  `book_pd_amount` decimal(10,2) unsigned DEFAULT '0.00' COMMENT '现金券支付金额',
...
CREATE TABLE `#__pd_cash` (
  ...
  PRIMARY KEY (`pdc_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='现金券提现记录表';
...
CREATE TABLE `#__pd_log` (
  ...
  `lg_type` varchar(15) NOT NULL DEFAULT '' COMMENT 'order_pay下单支付现金券,order_freeze下单冻结现金券,order_cancel取消订单解冻现金券,order_comb_pay下单支付被冻结的现金券,recharge充值,cash_apply申请提现冻结现金券,cash_pay提现成功,cash_del取消提现申请，解冻现金券,refund退款',
  ...
  PRIMARY KEY (`lg_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='现金券变更日志表';
...
CREATE TABLE `#__pd_recharge` (
  ...
  PRIMARY KEY (`pdr_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='现金券充值表';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='红包模版表';
...
CREATE TABLE `#__refund_detail` (
  ...
  `pd_amount` decimal(10,2) DEFAULT '0.00' COMMENT '现金券金额',
...
('hao_top_banner_color', '#810304'),
('hao_top_banner_name', '好商城V5.7'),
('hao_top_banner_pic', '05730518406053412.png'),
('hao_top_banner_status', '1'),
('hao_top_banner_url', 'hhttp://www.33hao.com/buy.html'),
('hao_webchat_appid', ''),
('hao_webchat_appsecret', ''),
('hao_invite2', '70'),
('hao_invite3', '80'),
('hot_search', '好商城V5.7,33hao,手表,内衣,小米,手机'),
('icp_number', ''),
...
CREATE TABLE `#__stat_member` (
  ...
  `statm_predincrease` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '现金券增加额',
  `statm_predreduce` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '现金券减少额',
...
CREATE TABLE `#__red_packet` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='红包抽奖';

CREATE TABLE `#__red_packet_list` (
...
INSERT INTO `#__setting` VALUES('flea_site_name','闲置市场 - by 33hao.com');
INSERT INTO `#__setting` VALUES('flea_site_title','闲置市场，二手市场');
INSERT INTO `#__setting` VALUES('flea_site_description','好商城33hao.com提供闲置市场模块');
INSERT INTO `#__setting` VALUES('flea_site_keywords','好商城33hao.com提供闲置市场模块');
INSERT INTO `#__setting` VALUES('flea_hot_search','好商城,男装,手机,笔记本,古董,奢侈品');
...
INSERT INTO `#__setting` (`name`, `value`) VALUES ('flea_loginpic', 'a:5:{i:1;a:2:{s:3:"pic";s:10:"flea_1.jpg";s:3:"url";s:21:"https://www.52pojie.cn/";}i:2;a:2:{s:3:"pic";s:10:"flea_2.jpg";s:3:"url";s:21:"https://www.52pojie.cn/";}i:3;a:2:{s:3:"pic";s:10:"flea_3.jpg";s:3:"url";s:0:"";}i:4;a:2:{s:3:"pic";s:10:"flea_4.jpg";s:3:"url";s:0:"";}i:5;a:2:{s:3:"pic";s:10:"flea_5.jpg";s:3:"url";s:0:"";}}');