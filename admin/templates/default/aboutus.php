  ...
  <div class="content">
    <div class="scroll switchbox" >
      <ul class="tema">
        <li>
          <h4>源码提供 - 吾爱破解</h4>
          <p>唯一官方网：<a href="https://www.52pojie.cn/" target="_blank">https://www.52pojie.cn</a></p>
          <p>唯一旺旺名：没有</p>
          <p>永远不会有QQ交流群</p>
    ...
    <div class="scrollbar switchbox" style="display: none;">
      <div class="law-notice">
        <p>程序来源：吾爱破解交流论坛 <a href="https://www.52pojie.cn" target="_blank">https://www.52pojie.cn</a>。</p>
        ...
        <p>为了你更好的使用本系统！请加登录吾爱破解论坛了解更多</p>
        <p>尊爱网络环境！禁止非法传播。</p>
      </div>
    </div>
    <div class="switchbox" style="display:none;" >
      <ul>
        ...
        <li>
          <h4>关注我们</h4>
          <p><?php echo $lang['dashboard_aboutus_website'];?> <a href="https://www.52pojie.cn" target="_blank">https://www.52pojie.cn</a></p>
