 ...
 * 优惠券功能公用
 */
$lang['admin_points_unavailable']	 		= '系统未开启优惠券功能';
$lang['admin_points_mod_tip']				= '修改优惠券';
$lang['admin_points_system_desc']			= '管理员手动操作优惠券';
...
$lang['admin_points_pointsnum']				= '优惠券值';
$lang['admin_points_pointsdesc']			= '描述';
$lang['admin_points_pointsdesc_notice']		= '描述信息将显示在优惠券明细相关页，会员和管理员都可见';

/**
 * 优惠券添加
 */
$lang['admin_points_member_error_again']	= '会员信息错误，请重新填写会员名';
$lang['admin_points_points_null_error']		= '请添加优惠券值';
$lang['admin_points_points_min_error']		= '优惠券值必须大于0';
$lang['admin_points_points_short_error']	= '优惠券不足，会员当前优惠券数为';
$lang['admin_points_addmembername_error']	= '请输入会员名';
$lang['admin_points_member_tip_1']			= '会员';
$lang['admin_points_member_tip_2']			= ', 当前优惠券数为';
/**
 * 优惠券日志
 */
$lang['admin_points_log_title']			= '优惠券明细';
...
$lang['admin_points_stage_system']				= '优惠券管理';
$lang['admin_points_stage_pointorder']		= '礼品兑换';
$lang['admin_points_stage_app']		= '优惠券兑换';
$lang['admin_points_addtime']				= '添加时间';
$lang['admin_points_addtime_to']				= '至';
$lang['admin_points_log_help1']				= '优惠券明细，展示了被操作人员（会员）、操作人员（管理员）、操作优惠券数（优惠券值，“-”表示减少，无符号表示增加）、操作时间（添加时间）等信息';
