...
$(function(){
    $("#flexigrid").flexigrid({
        ...
        colModel : [
            ...
            {display: '会员名称', name : 'lg_member_name', width : 100, sortable : true, align: 'center'},
            {display: '可用金额（元）', name : 'lg_av_amount', width : 90, sortable : true, align: 'left'},
	    {display: '变动前金额（元）', name : 'lg_av_before', width : 90, sortable : true, align: 'left'},
            {display: '冻结金额（元）', name : 'lg_freeze_amount', width : 90, sortable : true, align: 'left'},
            {display: '添加时间', name : 'lg_add_time', width : 120, sortable : true, align: 'left'},
	    {display: '管理员', name : 'lg_admin_name', width : 60, sortable : true, align: 'left'},
            {display: '日志描述', name : 'lg_desc' , sortable : false, align: 'left'}
            ],
        buttons : [
                   {display: '<i class="fa fa-file-excel-o"></i>导出数据', name : 'csv', bclass : 'csv', title : '导出Excel文件', onpress : fg_operation }
               ],
        searchitems : [
	    {display: '描述', name : 'lg_desc'},
