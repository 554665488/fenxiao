<?php defined('In33hao') or exit('Access Invalid!');?>
  <div class="ncap-form-default">
    ...
    <dl class="row">
      <dt class="tit">
        <label>手续费(<?php echo $output['info']['fee_rate']; ?>)</label>
      </dt>
      <dd class="opt"><?php echo $output['info']['fee']; ?>&nbsp;<?php echo $lang['currency_zh'];?>
        <p class="notic"></p>
      </dd>
    </dl>
    <dl class="row">
      ...
      <dd class="opt"><?php echo $output['info']['real_amount']; ?>&nbsp;<?php echo $lang['currency_zh'];?>
        <p class="notic"></p>
      </dd>
    </dl>
