  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?act=points&op=pointslog">积分明细</a></li>
  ...
  <form id="points_form" method="post" name="form1">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <select id="cang_type" name="cang_type">
          <option value="sf">积分</option>
          </select>
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
...
function checkmember(){
	...
	$.getJSON("index.php?act=points&op=checkmember", {'name':membername}, function(data){
	        ...
	        {
		        $("#tr_memberinfo").show();
				var msg= "<?php echo $lang['admin_points_member_tip']; ?> "+ data.name + "当前积分数为" + data.points;
