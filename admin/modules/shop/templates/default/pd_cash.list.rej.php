  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="JavaScript:void(0);" href="index.php?act=predeposit&op=pd_cash_list"><?php echo $lang['admin_predeposit_cashmanage']; ?></a></li>
	<li><a href="index.php?act=predeposit&op=pd_cash_list&state=payed">已提现</a></li>
	<li><a  class="current">提现拒绝</a></li>
...
$(function(){
    ...
    $('#ncreset').click(function(){
        $("#flexigrid").flexOptions({url: 'index.php?act=predeposit&op=get_cash_xml&pdc_payment_state=0'}).flexReload();
        $("#formSearch")[0].reset();
    });
    
    $("#flexigrid").flexigrid({
        url: 'index.php?act=predeposit&op=get_cash_xml&pdc_payment_state=2',
        colModel : [
            ...
            {display: '会员名称', name : 'pdc_member_name', width : 120, sortable : true, align: 'center'},
            {display: '提现金额（元）', name : 'pdc_amount', width : 100, sortable : true, align: 'left'},
            {display: '申请时间', name : 'pdc_add_time', width : 150, sortable : true, align: 'left'},
            {display: '收款银行', name : 'pdc_bank_name', width : 150, sortable : true, align: 'center'},
            {display: '收款账号', name : 'pdc_bank_no', width : 150, sortable : true, align: 'center'},
            ...
            {display: '支付时间', name : 'pdc_payment_time', width : 150, sortable : true, align: 'center'},
