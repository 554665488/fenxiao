...
$(function(){
    $("#flexigrid").flexigrid({
        ...
        colModel : [
            ...
            {display: '邀请人', name : 'member_inviter', width : 80, sortable : true, align: 'left'},
            {display: '会员业绩', name : 'achievement', width : 60, sortable : true, align: 'center'},
            {display: '会员手机', name : 'member_mobile', width : 80, sortable : true, align: 'center'},
            {display: '会员等级', name : 'level', width : 160, sortable : false, align: 'center'},
            ...
            {display: '积分', name : 'member_points', width : 60, sortable : true, align: 'center'},
            {display: '可用优惠券', name : 'member_points2', width : 100, sortable : true, align: 'center', className: 'normal'},
