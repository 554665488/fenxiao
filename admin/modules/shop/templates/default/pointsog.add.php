  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="JavaScript:void(0);" class="current">增值券原始仓</a></li>
        <li><a href="index.php?act=points&op=pvlog">PV值明细</a></li>
        <li><a href="index.php?act=points&op=tibilog">提币明细</a></li>
          </ul>
    </div>
  </div>
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <span class="err"></span>
          <p class="notic">描述信息将显示在增值券明细相关页，会员和管理员都可见</p>
        </dd>
      </dl>
...
function checkmember(){
	...
	$.getJSON("index.php?act=points&op=checkmember&type=og", {'name':membername}, function(data){
	        if (data)
	        {
		        $("#tr_memberinfo").show();
				var msg= "<?php echo $lang['admin_points_member_tip']; ?> "+ data.name + "当前原始仓数为" + data.points;
