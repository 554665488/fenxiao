  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?act=points2&op=pointslog">优惠券明细</a></li>

        <li><a href="JavaScript:void(0);" class="current">优惠券增减</a></li>
      </ul>
    </div>
  </div>
...
function checkmember(){
	...
	$.getJSON("index.php?act=points2&op=checkmember", {'name':membername}, function(data){
	        if (data)
	        {
		        $("#tr_memberinfo").show();
