...
<div class="page">
  <div class="fixed-bar">
	...
	<li><a href="javascript:void(0)" class="current">已提现</a></li>
...
$(function(){
    ...
    $('#ncreset').click(function(){
        $("#flexigrid").flexOptions({url: 'index.php?act=predeposit&op=get_cash_xml&pdc_payment_state=1'}).flexReload();
        $("#formSearch")[0].reset();
    });
    
    $("#flexigrid").flexigrid({
        url: 'index.php?act=predeposit&op=get_cash_xml&pdc_payment_state=1',
        colModel : [
