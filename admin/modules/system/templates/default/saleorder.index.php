...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      </div><ul class="tab-base nc-row"><li><a class="current"><span>出售中</span></a></li><li><a href="index.php?act=saleorder&op=saled" ><span>已完成</span></a></li></ul>
    </div>
  </div>
  <!-- 操作说明 -->
        ...
        <div class="layout-box">
          <dl>
            ...
            <dd>
			  ...
			  <label>
                <input type="checkbox" value="1" name="jq_first">首单
              </label>
            </dd>
          </dl>
          <dl>
...
$(function(){
    ...
    $("#flexigrid").flexigrid({
        url: 'index.php?act=saleorder&op=get_xml',
        colModel : [
