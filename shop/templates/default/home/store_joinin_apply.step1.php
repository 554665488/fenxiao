  ...
  <form id="form_company_info" action="index.php?act=store_joinin&op=step2" method="post">
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        <tr>
          <th><i>*</i>公司名称：</th>
          <td><input name="company_name" type="text" class="w200" value="<?php echo $output['store_info']['company_name']; ?>"/>
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i>公司所在地：</th>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        <tr>
          <th><i>*</i>营业执照号：</th>
          <td><input name="business_licence_number" type="text" value="<?php echo $output['store_info']['business_licence_number']; ?>" class="w200" />
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i>营业执照所在地：</th>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        <tr>
          <th><i>*</i>组织机构代码：</th>
          <td><input name="organization_code" type="text" class="w200" value="<?php echo $output['store_info']['organization_code']; ?>" />
            <span></span></td>
        </tr>
        <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      <thead>
        <tr>
          <th colspan="20">一般纳税人证明<em>注：所属企业具有一般纳税人证明时。</em></th>
        </tr>
      </thead>
      <tbody>
        <tr>
