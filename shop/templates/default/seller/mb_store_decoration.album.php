...
<div class="ncsc-form-default">
  <form method="post" action="index.php?act=mb_store_decoration&op=decoration_album" enctype="multipart/form-data" id="my_store_form">
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="hint">选择是否使用手机店铺导航装修模板；<br/>
          ...
          如选择“否”根据 <a href="index.php?act=store_setting&op=theme">“默认手机店铺导航主题”</a> 所选中的系统预设值风格进行显示。</p>
      </dd>
    </dl>
...
$(function() {
    ...
    $('input.input-file').change(function() {
        ...
        $.ajaxFileUpload({
            url: 'index.php?act=mb_store_decoration&op=store_mb_sliders',
            secureuri: false,
            fileElementId: id,
            dataType: 'json',
            data: {id: id},
    ...
    $("a[data-slider-drop]").click(function() {
        ...
        $.getJSON('index.php?act=mb_store_decoration&op=store_mb_sliders_drop', {id: id}, function(d) {
            if (!d.success) {
                alert(d.error);
                return;
            }
