...
<div class="index_block goods-list">
  ...
  <div nctype="item_content" class="content">
    ...
    <div nctype="item_image" class="item">
      <div class="goods-pic"><img nctype="goods_image" src="<?php echo getCMSArticleImageUrl($item_value['article_attachment_path'], $item_value['article_image']['name']);?>" alt=""></div>
      <div class="goods-name" nctype="goods_name"><?php echo $item_value['article_title'];?></div>
      <div class="goods-price" nctype="goods_price"><?php echo $item_value['article_abstract'];?></div>
      <?php if($item_edit_flag) { ?>
