...
<div class="ncsc-form-default">
  <form method="post" action="index.php?act=mb_store_decoration&op=decoration_menu" enctype="multipart/form-data" id="my_store_form">
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="hint">选择是否使用手机店铺底部菜单装修模板；<br/>
          ...
          如选择“否”根据 <a href="index.php?act=store_setting&op=theme">“默认手机店铺底部菜单主题”</a> 所选中的系统预设值风格进行显示。</p>
      </dd>
    </dl>
 <?php for ($k = 0; $k <= 4; $k++) {  ?>    
