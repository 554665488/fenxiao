...
<form method="get" action="index.php">
  <table class="search-form">
    ...
    <tr>
      <td>&nbsp;</td>
      <th>商品类型</th>
      <td class="w160"><select name="type_id" class="w150">
        <option value=""><?php echo $lang['nc_please_choose'];?></option>
        <option value="0" <?php if ($_GET['type_id'] == "0") {?>selected<?php }?>>零售区</option>
        <option value="1" <?php if ($_GET['type_id'] == "1") {?>selected<?php }?>>折扣区</option>
        <option value="2" <?php if ($_GET['type_id'] == "2") {?>selected<?php }?>>平价区</option>
      </select></td>
      <th>供货商</th>
...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><span><?php if($val['z_goods_type'] == "0") { echo "零售区";} else if($val['z_goods_type'] == "1") {  echo "折扣区"; } else {echo "平价区";} ?></span></td>
