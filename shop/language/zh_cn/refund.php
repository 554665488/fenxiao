...
$lang['refund_buyer_desc']	= '每种商品只能退款或退货一次，建议与商家沟通后认真填写。如果同意退货，请及时发货并联系商家收货，平台确认后会将金额以现金券的形式返还给你。';
...
$lang['order_refund_freeze_predeposit'] = '退款减少现金券冻结金额';
$lang['order_refund_add_predeposit'] = '退款增加现金券可用金额';
$lang['order_completed_freeze_predeposit'] = '确认收货减少现金券冻结金额';
