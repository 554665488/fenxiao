        ...
        try {
            ...
            foreach ($order_list  as $order_info) {
              if($order_info['order_state'] == ORDER_STATE_PAY) {
                Model('predeposit')->setOrderApointsPrice($order_info['order_id']);
              } else {
                throw new Exception("现金券不足！");
