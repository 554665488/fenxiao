...
class member_fundControl extends mobileMemberControl {
     ...
     * 优惠券余额变更日志
     */
    public function youjinquanLogOp()
    {
        ...
        //$where, $field = '*', $limit = 0, $page = 0, $order = '', $group = ''
        $log_list = $model_points2->getPointsLogList($where, '*', 0, $this->page, '','');
        $page_count = $model_points2->gettotalpage();
