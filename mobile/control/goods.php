...
class goodsControl extends mobileHomeControl{
    ...
    public function goods_listOp() {
        ...
        //所需字段
        $fieldstr = "goods_id,goods_commonid,store_id,goods_name,goods_jingle,goods_price,goods_promotion_price,goods_promotion_type,goods_marketprice,goods_image,goods_salenum,evaluation_good_star,evaluation_count,points2,z_goods_type,goods_apoint_rate,goods_point_rate2";
    ...
    private function _goods_list_order($key, $order) {
        $result = 'sort desc,goods_id desc';
        if (!empty($key)) {
